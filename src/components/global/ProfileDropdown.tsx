...
const ProfileDropdown = ({setProfileToggle}:ProfileDropdownProps) => {
  ...
  return (
    <div className="min-w-48 p-2">
      <div className="border-b border-gray-400">
        <h1 className="text-lg font-semibold text-neutral-800">Raju Chhetry</h1>
        <h3 className="text-sm text-gray-700">rajuchhetry@gmail.com</h3>
      </div>
