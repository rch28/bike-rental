import { Bike } from "@/components/global/Bike";
...
const BikeOnRentPage = () => {
  const BikeData: Bike[] = [
...

    {
        ...
        features: { start: "SELF START ONLY", engine: "249 cc Engine", distance: "190 km/day" },
        price: "1000",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "803 cc Engine", distance: "220 km/day" },
        price: "2500",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "883 cc Engine", distance: "230 km/day" },
        price: "2800",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "649 cc Engine", distance: "240 km/day" },
        price: "2200",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "373 cc Engine", distance: "210 km/day" },
        price: "1400",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "765 cc Engine", distance: "250 km/day" },
        price: "2700",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "199 cc Engine", distance: "180 km/day" },
        price: "1000",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "321 cc Engine", distance: "190 km/day" },
        price: "1500",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "948 cc Engine", distance: "280 km/day" },
        price: "3000",
      },
      {
        id: new Date().getTime(),
        ...
        features: { start: "SELF START ONLY", engine: "199 cc Engine", distance: "170 km/day" },
        price: "900",
      }
  ];
  return (
